...
#' Uses \code{\link[pls]{'oscorespls'}} method of \code{\link[pls]{plsr}} function . 
...
#' }
#' @export
PLS.Loadings<-function(dataSet, analSet, imgName, format="png", dpi=72, width=NA, inx1 = 1, inx2 = 2, plotType, lbl.feat=1){	
