...
install.packages(c( "netcdf", "imagemagick", "graphviz", "Rserve", "ellipse",
                    ...
                    "RJSONIO", "SSPA", "caTools", "ROCR", "pROC", "devtools"))
```
...
```
## Step 5. Statistical analysis
REMEMBER: you always can read about different statistics, their outputs and etc. in detail in [MetaboAnalyst tutorial](http://www.metaboanalyst.ca/faces/home.xhtml). Just open the file and use Ctrl+F.
